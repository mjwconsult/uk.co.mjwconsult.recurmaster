 ...
 */
class CRM_Recurmaster_Upgrader_Base {

  /**
   * @var CRM_Recurmaster_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Recurmaster_Upgrader(
        'uk.co.mjwconsult.recurmaster',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Recurmaster_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Recurmaster_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
